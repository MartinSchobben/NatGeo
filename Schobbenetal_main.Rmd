...
plot.gl.d <- plot.els$glauc %>% 
                ...
                ggplot_grad_rects(45, 86, 99, -1, 0, "#d8b365", 
                                  sec = sec.select, 
                                  lab.ev = "physical weathering", 
                                  ypos = 65) +
                ggplot_grad_rects(25, 89, 70, -1, 0, "#d8b365", 
                                  sec = sec.select, 
                                  lab.ev = "physical weatheringt", 
                                  ypos = 94) +
...
ggsave(paste0(data.path, "figures/Fig2.pdf"), 
       str_plots , height = 15.7, width = 19, unit = "cm",
       device = cairo_pdf)
...
ggsave("figures/Fig3.pdf", cr_plots, height = 7, width = 20, unit = "cm")
...
**Correspondence** should be addressed to MS (m.a.n.schobben@uu.nl). PBW (P.B.Wignall@leeds.ac.uk) and SP (planke@vbpr.no) should be consulted for **material requests**.
