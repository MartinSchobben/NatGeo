...
## Implications for extinction selectivity 
 ...
 In accordance with theoretical ecological models[@Barnosky2012], environmental deterioration of the marine realm began before the main extinction pulse. The initial development of hypoxic/anoxic water masses, which were preferentially situated in shallow marine environments in the Boreal region[@Algeo2012], may thus be regarded as a prelude to the impending mass extinction, corroborating palaeontological evidence for pre-extinction ecosystem stress and species decline among certain taxa[@Kiessling2018].
   ...
   Our redox model also resolves the apparent conflict between the timing of magmatic activity[@Burgess2017], enhanced weathering[@Sun2018], and independent proxy records for the global-scale spread of euxinic water masses[@Brennecka2011a; @Schobben2015], and it was this that initiated the main marine extinction pulse. Based on the benthos that survived the end-Permian mass extinction at Deltadalen, the dominance of molluscs in the Early Triassic, having a planktotrophic larval stage[@Foster2017] (see Supplementary Discussion) and a high-tolerance to low-oxygen conditions seems important for survival. Their larvae could rapidly disperse over large distances in the oxygenated surface waters, thus increasing chance of survival in habitable locations during the expansion and contraction of euxinic conditions. However, selective pressures between benthic groups with planktotrophic larval stages would also have existed, as during the extinction sea surface temperatures rose dramatically, which would have selected against animals that were unable to increase metabolic rates (e.g., brachiopods[@Peck2007]). Changes in marine redox conditions across large stretches of the shelf was the dominant control of extinction selectivity at the end of the Permian. 
