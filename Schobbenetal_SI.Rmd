...
```{r FigGeograph,  anchor="figure", fig.cap = "Geographical setting of the Festningen section (1) and Deltadalen core (2). Lithofacies of Spitsbergen after ref @Harland1997. Map from DIVA-GIS[@Hijmans2004]"}
...
knitr::kable(sum_stat_d13C, digits = 1, booktabs = TRUE,
  caption = "Summary statistics $\\delta$^13^C~org~ of reference materials, excluding first and last batch of the sequence.")
