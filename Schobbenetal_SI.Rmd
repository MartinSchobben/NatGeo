...
text.6  <-  grid.text(label= "Permian–Triassic (251.9 Mya)",  x=unit(0.2,"npc"), y=unit(0.94 ,"npc"),  gp=gpar(fontsize=7), draw=FALSE)
...
```{r FigPetro, fig.cap = "Microscale mineralogical and elemental variations mapped for A--B) Deltadalen at 95.9$\\,$m depth, and C--D) Festningen 1.6$\\,$m height above the base of the Vardebukta Formation. Note, that the fine sand-sized clast of Deltadalen are composed of quartz and apatite shell fragments (likely belonging to the inarticulate brachiopods) with porespaces occupied by glauconite and authigenic apatite infillings. Clasts of Festningen are clay-sized, and, although, P is detected with EDS, P bearing minerals could not be identified. The mineral assemblage is dominated by dolomite, ankerite  and  sheet silicates.", out.width="200%"}
